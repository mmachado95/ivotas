...
public class Admin extends UnicastRemoteObject implements AdminInterface, Serializable {
  ...
  public static void menu(RMIServerInterface r, Admin a) {
    while(true) {
  ...
  public static void createUser(RMIServerInterface r, Admin a) {
  ...
  public static void management(RMIServerInterface r, Admin a) {
  ...
  public static void createElection(RMIServerInterface r, Admin a) {
    String name = getValidString("Name: ");
  ...
  public static void createCandidateList(RMIServerInterface r, Admin a) {
  ...
  public static void createVotingTable(RMIServerInterface r, Admin a) {
  ...
  public static void changeElectionsProperties(RMIServerInterface r, Admin a) {
  ...
  public static void knowWhereUserVoted(RMIServerInterface r, Admin a) {
  ...
  public static void pastElections(RMIServerInterface r, Admin a) {
    try {
  ...
  public static void printNotifications(RMIServerInterface r, Admin a) {
    try {
      r.subscribe(a);
  ...
  public static void connectRMIInterface(Admin a) {
    try {
      RMIServerInterface r = (RMIServerInterface) LocateRegistry.getRegistry(a.IPAddress, a.port).lookup("ivotas");
  ...
  public static void printData(RMIServerInterface r, Admin a) {
